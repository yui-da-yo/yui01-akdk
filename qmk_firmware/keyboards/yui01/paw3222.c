...
#pragma message("Auto-KDK Trackball support is enabled for this configuration.")
#else
#pragma message("Auto-KDK Trackball support is disabled for this configuration.")
#endif // AUTO_KDK_TRACKBALL_ENABLED